...
export const SEED_KERNEL: SeedTheory[] = [
  ...
  // ── 数学未解決問題の構造的公理（unsolved_problems）Theory #175〜#180 ──
  { id: 'dfumt-riemann-bridge', axiom: '素数分布(離散・局所)とゼータ零点(連続・全体)の間にNEITHERな第三の対象が存在する', category: 'unsolved_problems', keywords: ['リーマン予想', 'NEITHER', '素数', 'ゼータ関数'] },
  { id: 'dfumt-flowing-conjecture', axiom: '証明なき数学的予想はFLOWING状態——偽でも真でもなく新言語の発明を待つ流動的真実', category: 'unsolved_problems', keywords: ['FLOWING', '未証明', '予想', '認識論'] },
  { id: 'dfumt-concept-genesis-necessity', axiom: '難問の証明には問題提起時代に存在しない新概念の発明が必要(ポアンカレ→リッチフロー)', category: 'unsolved_problems', keywords: ['概念発生', 'FLOWING', 'リッチフロー', '証明'] },
